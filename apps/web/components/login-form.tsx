...
export function LoginForm({
  ...
  const isUnverifiedError =
    loginMutation.error?.message?.toLowerCase().includes("not verified") ||
    loginMutation.error?.message?.toLowerCase().includes("verify your account");
            ...
            >
              ...
              {isUnverifiedError && (
                <p className="text-xs mt-2">
                  Please check your email inbox for the verification link. If
